    ...
    <div className="relative bg-[#F0F0F0] text-white pt-[189px] pb-[77px] py-[186px] lg:py-[140px] px-[18px] lg:px-[100px]">
      ...
      <div className="flex flex-col md:flex-row md:justify-between gap-8">
        ...
        <div className="md:w-1/3 lg:w-1/5">
          <img
            src="/assets/logo/SHOP.CO.svg"
            alt="Logo"
            className="mb-[25px]"
          />
          <p className="text-[14px] leading-[22px] text-black text-opacity-60">
          ...
          <div className="flex gap-3 mt-4">
            ...
            >
              <FaXTwitter className="h-[11px] w-[11px] text-black group-hover:text-white" />
            </a>
            ...
            <a
              ...
              className="group flex items-center justify-center p-[9px] rounded-full border border-black border-opacity-20 bg-white transition-colors duration-300 hover:bg-black"
            >
              <FaFacebook className="h-[11px] w-[11px] text-black group-hover:text-white" />
            </a>
            ...
            <a
              ...
              className="group flex items-center justify-center p-[9px] rounded-full border border-black border-opacity-20 bg-white transition-colors duration-300 hover:bg-black"
            >
              <FaGithub className="h-[11px] w-[11px] text-black group-hover:text-white" />
            </a>
            ...
            <a
              ...
              className="group flex items-center justify-center p-[9px] rounded-full border border-black border-opacity-20 bg-white transition-colors duration-300 hover:bg-black"
            >
              <FaInstagram className="h-[11px] w-[11px] text-black group-hover:text-white" />
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-black border-opacity-10 flex flex-col items-center gap-4 lg:flex-row lg:justify-between mt-[50px] py-[25px]">
